...
const ROOTS = ["app", "components", "lib", "data", "config", "prisma", "supabase"];
const EXTENSIONS = new Set([".ts", ".tsx", ".js", ".jsx", ".json", ".md", ".sql"]);
const MOJIBAKE = /Рљ|Р°|Рµ|РЅ|Рё|СЏ|С‚|СЃ|Рџ|Р”|Р‘|Р’|Рњ|Рќ|Рћ|Рў|РЈ|Р¤|РҐ|СЊ|С‹|С‡|С€|С‰|вЂ|В©|в‚/g;
...
for (const root of ROOTS) {
  for (const filePath of walk(root)) {
    ...
    if (found?.length) matches.push({ filePath, count: found.length });
  }
}
