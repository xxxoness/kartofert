    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Если цена указана временно или требует уточнения, оставьте заявку: менеджер подтвердит наличие, фасовку и итоговую стоимость партии."
        ]
      },
      {
        heading: "Что уточнить у продавца",
        paragraphs: [
          ...
          "KartoFert не позиционирует товары как собственное производство: сайт помогает выбрать тип удобрения, рассчитать количество и отправить заявку."
        ]
      }
    ],
    tips: [
